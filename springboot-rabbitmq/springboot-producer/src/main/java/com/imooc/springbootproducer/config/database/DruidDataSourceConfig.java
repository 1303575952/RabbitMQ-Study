package com.imooc.springbootproducer.config.database;
...
public class DruidDataSourceConfig {
    private static Logger logger = LoggerFactory.getLogger(com.imooc.springbootproducer.config.database.DruidDataSourceConfig.class);
